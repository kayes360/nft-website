    ...
    <div className="container my-5">
      <div className="row">
        <div className="col-lg-3 col-md-3 col-sm-12 col-12">
          <div className="">
            <div className="logo">
              <span className="logo-text text-dark">NFTERS</span>
            </div>
            <div className="my-5">
        ...
        <div className="col-lg-2 col-md-2 col-sm-12 col-12">
          <div>
            <ul className="ps-0">
              <li className="fw-bold mb-4">Market Place</li>
              <li>All NFTs</li>
              <li>New</li>
              <li>Art</li>
              <li>Sports</li>
        ...
        <div className="col-lg-2 col-md-2 col-sm-12 col-12">
          <div>
            <ul className="ps-0">
              <li className="fw-bold mb-4">My Account</li>
              <li>Profile</li>
              <li>Favorite</li>
        ...
        <div className="col-lg-5 col-md-5 col-sm-12 col-12">
          <div>
            <p className="fw-bold">Stay In The Loop</p>
          </div>
          <div>
            <p>
          ...
          <div className="">
            <div
              className="footer-input input-group mb-3 border border-3 rounded-pill p-1"
            >
              <input
                type="text"
              ...
              />
              <button
                className="btn rounded-pill btn-bright-blue"
                type="button"
                id="button-addon2"
              >
                Subscribe Now
