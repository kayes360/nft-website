...
export default function AmazeNFT() {
  return (
    <section className="bg-light-grey section-two  ">
    <div className="container">
      <div className="row py-5">
        <div className="col-xx-4 col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
          <div>
            <p className="section-two-heading">
        ...
        <div className="col-xx-4 col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
          <div>
            <div className="d-flex ms-2">
              ...
              <div className="ms-3">
                <p className="fw-bold">Fast Transaction</p>
                <p>
        ...
        <div className="col-xx-4 col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
          <div>
            <div className="d-flex">
              ...
              <div className="ms-3">
                <p className="fw-bold">Growth Transaction</p>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
